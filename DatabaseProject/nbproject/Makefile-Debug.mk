...
${OBJECTDIR}/Composer.o: Composer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Composer.o Composer.cpp

${OBJECTDIR}/ComposerDatabaseUserInterface.o: ComposerDatabaseUserInterface.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComposerDatabaseUserInterface.o ComposerDatabaseUserInterface.cpp
...
${TESTDIR}/tests/testComposerImplementation.o: tests/testComposerImplementation.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testComposerImplementation.o tests/testComposerImplementation.cpp


${TESTDIR}/tests/testDatabaseImplementation.o: tests/testDatabaseImplementation.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testDatabaseImplementation.o tests/testDatabaseImplementation.cpp
...
${OBJECTDIR}/Composer_nomain.o: ${OBJECTDIR}/Composer.o Composer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Composer_nomain.o Composer.cpp;\
	else  \
...
${OBJECTDIR}/ComposerDatabaseUserInterface_nomain.o: ${OBJECTDIR}/ComposerDatabaseUserInterface.o ComposerDatabaseUserInterface.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComposerDatabaseUserInterface_nomain.o ComposerDatabaseUserInterface.cpp;\
	else  \
...
${OBJECTDIR}/Database_nomain.o: ${OBJECTDIR}/Database.o Database.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Database_nomain.o Database.cpp;\
	else  \
